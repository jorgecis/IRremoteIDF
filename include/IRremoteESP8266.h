...
#include "IRconfig.h"  // menuconfig -> library macros. Must precede the
...
// Debug output (DPRINT/DPRINTLN) and the String/F() shims live in
// IRplatform.h, which is included at the top of this file.
